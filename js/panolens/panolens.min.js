...
dispose:function(){this.pauseVideo();this.removeEventListener("leave",this.pauseVideo.bind(this));this.removeEventListener("enter-fade-start",this.resumeVideoProgress.bind(this));this.removeEventListener("video-toggle",this.toggleVideo.bind(this));this.removeEventListener("video-time",this.setVideoCurrentTime.bind(this));m.prototype.dispose.call(this)}});Object.assign(Z.prototype,{constructor:Z,setProgress:function(a,b){if(this.onProgress)this.onProgress({loaded:a,total:b})},adaptTextureToZoom:function(){var a=
this.widths[this._zoom],b=this.heights[this._zoom],c=this.maxW,e=this.maxH;this._wc=Math.ceil(a/c);this._hc=Math.ceil(b/e);for(var d=0;d<this._hc;d++)for(var h=0;h<this._wc;h++){var k=document.createElement("canvas");k.width=h<this._wc-1?c:a-c*h;k.height=d<this._hc-1?e:b-e*d;this._canvas.push(k);this._ctx.push(k.getContext("2d"))}},composeFromTile:function(a,b,c){var e=this.maxW,d=this.maxH;a*=512;b*=512;var h=Math.floor(a/e),k=Math.floor(b/d);this._ctx[k*this._wc+h].drawImage(c,0,0,c.width,c.height,
a-h*e,b-k*d,512,512);this.progress()},progress:function(){this._count++;this.setProgress(this._count,this._total);if(this._count===this._total&&(this.canvas=this._canvas,this.panoId=this._panoId,this.zoom=this._zoom,this.onPanoramaLoad))this.onPanoramaLoad(this._canvas[0])},composePanorama:function(){this.setProgress(0,1);var a=this.levelsW[this._zoom],b=this.levelsH[this._zoom],c=this;this._count=0;this._total=a*b;for(var e=this._parameters.useWebGL,d=0;d<b;d++)for(var h={},k=0;k<a;h={$jscomp$loop$prop$url$2:h.$jscomp$loop$prop$url$2},
k++)h.$jscomp$loop$prop$url$2="https://geo0.ggpht.com/cbk?cb_client=maps_sv.tactile&authuser=0&hl=en&output=tile&zoom="+this._zoom+"&x="+k+"&y="+d+"&panoid="+this._panoId+"&nbt&fover=2",function(a){return function(b,d){if(e)var g=I.load(a.$jscomp$loop$prop$url$2,null,function(){c.composeFromTile(b,d,g)});else{var f=new Image;f.addEventListener("load",function(){c.composeFromTile(b,d,this)});f.crossOrigin="";f.src=a.$jscomp$loop$prop$url$2}}}(h)(k,d)},load:function(a){this.loadPano(a)},loadPano:function(a){var b=
this;this._panoClient.getPanoramaById(a,function(a,e){e===google.maps.StreetViewStatus.OK&&(b.result=a,b.copyright=a.copyright,b._panoId=a.location.pano,b.composePanorama())})},setZoom:function(a){this._zoom=a;this.adaptTextureToZoom()}});aa.prototype=Object.assign(Object.create(u.prototype),{constructor:aa,load:function(a){this.loadRequested=!0;(a=a||this.panoId||{},this.gsvLoader)&&this.loadGSVLoader(a)},setupGoogleMapAPI:function(a){var b=document.createElement("script");b.src="https://maps.googleapis.com/maps/api/js?";
b.src+=a?"key="+a:"";b.onreadystatechange=this.setGSVLoader.bind(this);b.onload=this.setGSVLoader.bind(this);document.querySelector("head").appendChild(b)},setGSVLoader:function(){this.gsvLoader=new Z;this.loadRequested&&this.load()},getGSVLoader:function(){return this.gsvLoader},loadGSVLoader:function(a){this.loadRequested=!1;this.gsvLoader.onProgress=this.onProgress.bind(this);this.gsvLoader.onPanoramaLoad=this.onLoad.bind(this);this.gsvLoader.setZoom(this.getZoomLevel());this.gsvLoader.load(a);
this.gsvLoader.loaded=!0},onLoad:function(a){u.prototype.onLoad.call(this,new d.Texture(a))},reset:function(){this.gsvLoader=void 0;u.prototype.reset.call(this)}});var la={tDiffuse:{value:new d.Texture},resolution:{value:1},transform:{value:new d.Matrix4},zoom:{value:1},opacity:{value:1}};C.prototype=Object.assign(Object.create(u.prototype),{constructor:C,add:function(a){if(1<arguments.length){for(var b=0;b<arguments.length;b++)this.add(arguments[b]);return this}a instanceof y&&(a.material.depthTest=
!1);u.prototype.add.call(this,a)},createGeometry:function(a){return new d.PlaneBufferGeometry(a,.5*a)},createMaterial:function(a){a=void 0===a?this.edgeLength:a;var b=d.UniformsUtils.clone(la);b.zoom.value=a;b.opacity.value=0;return new d.ShaderMaterial({vertexShader:"\n\n        varying vec2 vUv;\n\n        void main() {\n\n            vUv = uv;\n            gl_Position = vec4( position, 1.0 );\n\n        }\n\n    ",fragmentShader:"\n\n        uniform sampler2D tDiffuse;\n        uniform float resolution;\n        uniform mat4 transform;\n        uniform float zoom;\n        uniform float opacity;\n\n        varying vec2 vUv;\n\n        const float PI = 3.141592653589793;\n\n        void main(){\n\n            vec2 position = -1.0 +  2.0 * vUv;\n\n            position *= vec2( zoom * resolution, zoom * 0.5 );\n\n            float x2y2 = position.x * position.x + position.y * position.y;\n            vec3 sphere_pnt = vec3( 2. * position, x2y2 - 1. ) / ( x2y2 + 1. );\n\n            sphere_pnt = vec3( transform * vec4( sphere_pnt, 1.0 ) );\n\n            vec2 sampleUV = vec2(\n                (atan(sphere_pnt.y, sphere_pnt.x) / PI + 1.0) * 0.5,\n                (asin(sphere_pnt.z) / PI + 0.5)\n            );\n\n            gl_FragColor = texture2D( tDiffuse, sampleUV );\n            gl_FragColor.a *= opacity;\n\n        }\n    ",
